<?php
        ...
        require("../app/controllers/Bank.php");
...
<div class="bg-gray-100">
    ...
    <form action="../app/controllers/Bank.php" method="post">
            ...
            <?php foreach($banks as $bank): ?>
                <tr>
                    ...
                    <form action="" method="post">
                        ...
                        <td>
                            <input type="text" name="logo" value="<?=$bank['logo']?>">
                        </td>
                        <td>
                        ...
                        <form action="../app/controllers/Bank.php" method="post">
                            <input type="hidden" name="delete_id" value="<?= $bank['id'] ?>">
                            <input type="hidden" name="action" value="deleteBank">
                            <button type="submit" name="delete" onclick="return confirm('Are you sure you want to delete this bank?')">Delete</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
