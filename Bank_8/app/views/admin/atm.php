...
<div class="bg-gray-100">
    ...
    <form action="../app/controllers/Atm.php" method="post">
        ...
        <input type="hidden" name="action" value="addAtm">
        ...
        <tbody>
            <?php foreach($atms as $atm): ?>
                <tr>
                    ...
                    <input type="hidden" name="action" value="editAtm">
                        ...
                        <td>
                            <input type="text" name="bank_id" value="<?=$atm['bank_id']?>">
                        </td>
                        <td>
                        <button type="submit" name="edit" onclick="return confirm('Are you sure you want to edit this atm?')">Edit</button>
                        </form>
                    <td><form action="../app/controllers/Atm.php" method="post">
                            <input type="hidden" name="delete_id" value="<?= $atm['id'] ?>">
                            <input type="hidden" name="action" value="deleteAtm">
                            <button type="submit" name="delete" onclick="return confirm('Are you sure you want to delete this atm?')">Delete</button>
                        </form></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
