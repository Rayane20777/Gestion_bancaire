<?php
        ...
        require("../app/controllers/Role.php");
...
<div class="bg-gray-100">
    ...
    <form action="../app/controllers/Role.php" method="post">
            ...
            <?php foreach($roles as $role): ?>
                <tr>
                    ...
                    <form action="" method="post">
                        ...
                        <td>
                        <button type="submit" name="edit" onclick="return confirm('Are you sure you want to edit this role?')">Edit</button>
                        </form>
                        
                        <form action="../app/controllers/role.php" method="post">
                            <input type="hidden" name="name" value="<?= $role['name'] ?>">
                            <input type="hidden" name="action" value="deleteRole">
                            <button type="submit" name="delete" onclick="return confirm('Are you sure you want to delete this role?')">Delete</button>
                        </form>
                        </td>
                </tr>
            <?php endforeach; ?>
